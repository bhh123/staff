...
public class RpPanel extends JPanel implements ActionListener {
    ...
    public void init(){
        ...
        jLabel2.setFont(new Font("微软雅黑",Font.PLAIN,25));
        upPanel.add(jLabel2);
        ...
        for (RewardPublish rp : list) {
            if ("奖".equals(rp.getFlag())) {
                ...
                rlist.setFont(new Font("", Font.PLAIN, 20));
            }
            if ("惩".equals(rp.getFlag())) {
                pdefaultListModel.addElement(rp);
                plist.setFont(new Font("",Font.PLAIN,20));
            }
        }
        ...
        exportButton.setFont(new Font("微软雅黑",Font.PLAIN,18));
