...
public class Style {
    ...
    private final static Font GROUP_FONT = new Font("微软雅黑",Font.PLAIN,22);
    private final static Font ITEM_FONT = new Font("微软雅黑",Font.PLAIN,20);
    private final static Font NOMAL_FONT = new Font("微软雅黑",Font.PLAIN,18);
    private final static Font SMALL_FONT = new Font("微软雅黑",Font.PLAIN,16);
